...
class DetailFragment : BaseBackFragment() {
    ...
    private fun initDelayView() {
        ...
        mFab!!.setOnClickListener { startForResult(ModifyDetailFragment.newInstance(this!!.mTitle!!), REQ_MODIFY_FRAGMENT) }
    }
    ...
    companion object {
        val TAG = DetailFragment::class.java!!.getSimpleName()
